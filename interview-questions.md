...
5. Debug the pre-written methods based on:
    - For this, imagine that a web application exists to manage the population of cantons. It uses the `Get` and `UpdateCantonPopulation` methods in the `CantonsController`
    - Document your steps to analyze the problem, and what solutions you would implement to mitigate this problem.
